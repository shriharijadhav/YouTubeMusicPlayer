...
function ModalForPlaylist() {
  const { setOpenModalForPlaylist,setUrlArray,urlArray,setSuggestedPlaylistFlag,setSuggestedPlaylistLength,successToast} = useContext(topLevelContext);
  return (
