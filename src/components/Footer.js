...
const Footer = () => {
  const handleOnclick = () =>{
    window.open('https://shriharijadhav.vercel.app/', '_blank');

  }
  return (
    <div className='relative max-w-sm w-full mt-10 pb-8'>
   
    <div className='flex flex-col w-full justify-center items-center gap-5'>
        <div className='flex flex-row gap-3'>
            <CircularDiv backgroundColor={'transparent'} imagePath={harryLogo} title={"Portfolio"} socialProfileUrl={'https://shriharijadhav.vercel.app/'}/>
