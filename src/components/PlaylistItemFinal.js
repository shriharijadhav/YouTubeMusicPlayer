...
const PlaylistItemFinal = ({gradientClass,heading,headingTwo,topSinger,handlePlaylistSuggestionCLick,index}) => {
  return (
    <div className={`h-60 w-60 mx-auto rounded-2xl shadow-lg shadow-gray-600  my-5 flex flex-col justify-center items-center hover:cursor-pointer px-4 ${gradientClass}`} onClick={()=>{handlePlaylistSuggestionCLick(index)}} >
